					...
					<li class="list-group-item">
						<p class="list-group-title">
							<?php if ($row['running'] == 'true') { ?>
								<span title="Meeting is running">
									<i class="fa fa-circle text-success"></i>
								</span>
								<?php } else { ?>
									<span title="Meeting is not running">
										<i class="fa fa-circle text-grey-200"></i>
									</span>
								<?php } ?>
							<?php echo anchor ('coaching/virtual_class/class_details/'.$coaching_id.'/'.$row['class_id'], $row['class_name']); ?><br>
