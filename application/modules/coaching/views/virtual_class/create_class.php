					      ...
					      <div class="card-body">
							...
							<div class="form-group row ">
								...
								<div class="col-md-6">
									...
									<input type="date" class="form-control required" name="end_date" value="<?php echo set_value('end_date', $end_date); ?>" id="end_date_text" <?php if ($class['end_date'] > 0 ) echo ''; else echo 'disabled'; ?> />
								</div>
