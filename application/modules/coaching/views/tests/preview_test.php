	...
	<div class="col-md-10">
		...
		<?php } else { ?>
			<div class="alert alert-danger">
				...
				<p>You can <?php echo anchor('coaching/tests/question_group_create/'.$coaching_id.'/'.$category_id.'/'.$test_id, 'Create Questions', array ('class'=>'btn btn-sm btn-primary') ); ?> or <?php echo anchor('coaching/tests/upload_test_questions/'.$coaching_id.'/'.$category_id.'/'.$test_id, 'Upload Questions', array ('class'=>'btn btn-sm btn-secondary') ); ?> in this test.
				</p>
			</div>
			<?php 
		} 
