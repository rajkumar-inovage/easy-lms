			            ...
			            <div class="d-flex flex-grow-1 min-width-zero">
			                <div class="card-body align-self-center d-flex flex-column flex-md-row justify-content-between min-width-zero align-items-md-center">
			                    ...
			                    <div class="w-20 w-xs-100">
				                    <?php if ($row['resource_type'] == COURSE_CONTENT_TEST) { ?>
										<a href="<?php echo site_url ('coaching/tests/take_test/'.$coaching_id.'/'.$course_id.'/'.$row['id']); ?>" class="btn btn-outline-danger shadow-sm">Take Test <i class="fa fa-arrow-right"></i></a>
				                    <?php } else { ?>
