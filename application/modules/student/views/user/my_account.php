			...
			<div class="modal-body">
				<div class="form-group row"> 
					<div class="col-md-12">
						...
						<br>
						<div class="align-center "><a class="" id="remove_image" href="#" onclick="show_confirm ('Remove this image?', '<?php echo site_url('student/user_actions/remove_profile_image/'.$member_id); ?>')">Remove Image</a></div>
					</div>
				</div>
