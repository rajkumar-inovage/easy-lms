<div class="card card-default">
	...
	<div class="card-footer">
		<div class="d-flex justify-content-between text-center">
			...
			<p class="nav-link mb-0">
				<h4 class="badge bg-info rounded-circle height-30 width-30 d-flex align-items-center justify-content-center mx-auto"> <?php echo $ob_marks[$attempt_id]['obtained']; ?></h4>
				<span class="d-block mt-2">Score</span>
			</p>
			<p class="nav-link mb-0">
				<span class="badge bg-grey-300 rounded-circle height-30 width-30 d-flex align-items-center justify-content-center mx-auto"> <?php echo $brief['accuracy']; ?></span>
